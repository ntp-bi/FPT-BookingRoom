...
const AddEvent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!newAccount.password) {
            ...
            hasErrors = true;
        } else if (newAccount.password.length < 6 || newAccount.password.length > 30) {
            newErrors.password = "Mật khẩu phải dài từ 6 đến 30 ký tự.";
            hasErrors = true;
        } else {
            newErrors.password = "";
        }
                    ...
                    <div className="right">
                        <form onSubmit={handleSubmit}>
                            <div className="formInput">
                                <label>
                                    Tên tài khoản:<span className="check">*</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="formInput">
                                <label>
                                    Mật khẩu:<span className="check">*</span>
                                </label>
                                <input
                                    type="password"
                                    name="password"
                            ...
                            <div className="formInput">
                                <label>
                                    Tên giảng viên:<span className="check">*</span>
                                </label>
                                <select
                                    className="select"
                                    name="userId"
                            ...
                            {/* <div className="formInput">
                                <label>Quyền:<span className="check">*</span></label>
                                <select
                                    className="select"
                                    name="roleId"
