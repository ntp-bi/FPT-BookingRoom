    ...
    useEffect(() => {
        const fetchTeacher = async () => {
            try {
                ...
                teacherData.birthDay = moment(teacherData.birthDay, "YYYY/MM/DD").format("YYYY-MM-DD");
                setTeacher(teacherData);
                setImagePreview(`${baseIMG}/${teacherData.photo}`);
            } catch (error) {
            ...
            <div className="addContainer">
                ...
                <div className="bottom">
                    <form onSubmit={handleSubmit}>
                        <div className="left">
                            <img
                                src={imagePreview || `${baseIMG}/${teacher.photo}`}
                                alt=""
                                className="image"
                            />
