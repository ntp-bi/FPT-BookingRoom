...
const AddTeacher = () => {
    ...
    const handleTeacherInputChange = (e) => {
        ...
        setNewTeacher({ ...newTeacher, [name]: newValue });
    };
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            setNewTeacher({ ...newTeacher, file: file });
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const birthday = newTeacher.birthDay || defaultBirthday; 
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="right">
                            <div className="formInput">
                                <label>Họ tên:<span className="check">*</span></label>
                                <input
                                    type="text"
