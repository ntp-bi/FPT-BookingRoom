...
const AddRoom = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!newRoom.countofseats) {
            newErrors.countofseats = "Vui lòng nhập diện số lượng chỗ ngồi.";
            hasErrors = true;
        } else if (newRoom.countofseats <= 0) {
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="right">
                                <div className="formInput">
                                    <label>Tên phòng:<span className="check">*</span></label>
                                    <input
                                        type="text"
                                ...
                                <div className="formInput">
                                    <label>Loại phòng:<span className="check">*</span></label>
                                    <select
                                        className="select"
                                ...
                                <div className="formInput">
                                    <label>Diện tích:<span className="check">*</span></label>
                                    <input
                                        type="number"
                                ...
                                <div className="formInput">
                                    <label>Số lượng chỗ ngồi:<span className="check">*</span></label>
                                    <input
                                        type="number"
